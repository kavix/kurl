...
## 🚀 Enhancements
- [x] **HTTP/3 Support**: Investigate and add experimental QUIC/HTTP3 fallback logic in the concurrency probing system.
...
- [x] Move `main.go` logic to an internal `app` or `cmd` subpackage to reduce root file size.
